variable "api_gateway_monitor_name" {
  description = "Name of the Datadog monitor for API Gateway"
  type        = string
}
...
variable "api_gateway_monitor_notify_no_data" {
  description = "Whether to notify when no data is available"
  type        = bool
  default     = false
}

variable "api_gateway_monitor_notify_audit" {
  description = "Whether to notify on audit events"
  type        = bool
  default     = false
}

variable "api_gateway_monitor_tags" {
